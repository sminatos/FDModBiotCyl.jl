...
902         format(A)
            ...
            read(5,*) fsource
            read(5,*) alpha
DAN            write(6,*) fout,sr1,nrec,dx,isrc,fsource,alpha
...
DAN          open(81,file='testi0.table8bin',form='unformatted')
DAN          open(82,file='testi1.table8bin',form='unformatted')
DAN          open(83,file='testk0.table8bin',form='unformatted')
DAN          open(84,file='testk1.table8bin',form='unformatted')
